...
class Boy:
    ...
    def calLines(self):
        ...
        self.rightY1 = self.pos.get('downR')[1]
        self.up = self.pos.get('upL')[1]
        self.down = self.pos.get('downL')[1]
    ...
    def draw(self):
        ...
        self.font.draw(self.x - self.bg.window_left - 40, self.y - self.bg.window_bottom + 70, '%5d' % (self.eatBallCnt), (0, 0, 0))
